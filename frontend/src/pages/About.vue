        ...
        <div class="row">
            <div class="about-content">
                ...
                <div class="about-content-text">
                    <p>Welcome to Mfood, where flavor knows no bounds in the heart of Ahmedabad!
                        Indulge in our tantalizing tacos, bodacious burritos, and crunchy nachos, expertly crafted with the freshest ingredients
                        and bold flavors. Pair your meal with our selection of sides, drinks, and desserts for a complete dining experience
                        that promises satisfaction with every bite.</p>

                    <p> Join us and embark on a culinary journey filled with warmth, flavor, and memorable moments. Welcome to MFood,
                        where every dish is a delight!
                    </p>
                    ...
                    <p>At MFood, our commitment goes beyond just serving delicious food. 
                        Step into our vibrant ambiance, where every corner is alive with satisfied diners, creating memorable
                        experiences. With attentive service and a dedication to excellence, we aim to create moments of
                        joy and connection for every guest.
                    
                    </p>
                    <p> Join us at Mfood!</p>
                </div>
            </div>
        </div>
